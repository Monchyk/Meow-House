...
Standalone, linkable from the README or a PR. GitHub renders the fenced block below natively. Source of truth: [`../src/system-topology.mmd`](../src/system-topology.mmd).
